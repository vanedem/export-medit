		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'{{WRAPPER}} .oew-news-bar-heading .oew-news-bar-heading-icon svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .oew-news-bar-heading .oew-news-bar-heading-icon svg' => 'fill: {{VALUE}};',
				),
			)
		);
