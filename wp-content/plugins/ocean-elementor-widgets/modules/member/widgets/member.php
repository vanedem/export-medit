	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .oew-member-icons {{CURRENT_ITEM}}' => 'background-color: {{VALUE}}',
				),
			)
		);
		...
		$repeater->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .oew-member-icons {{CURRENT_ITEM}}' => 'color: {{VALUE}}',
					'{{WRAPPER}} .oew-member-icons {{CURRENT_ITEM}} svg' => 'fill: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .oew-member-wrap .oew-member-icons a svg' => 'fill:{{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .oew-member-wrap .oew-member-icons a:hover svg' => 'fill: {{VALUE}}',
				),
			)
		);
