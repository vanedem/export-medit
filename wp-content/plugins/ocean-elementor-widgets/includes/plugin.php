...
class owpElementorPlugin {
	...
	public function register_scripts() {
		...
		if ( Plugin::$instance->experiments->is_feature_active( 'e_swiper_latest' ) ) {
			...
			wp_register_script(
				'swiper',
				plugins_url( '/assets/js/vendors/swiper/8.4.5/swiper-bundle.min.js', OWP_ELEMENTOR__FILE__ ),
				array(),
				'8.45',
				true
			);
			...
			wp_register_script(
				'swiper',
				plugins_url( '/assets/js/vendors/swiper/6.7.1/swiper-bundle.min.js', OWP_ELEMENTOR__FILE__ ),
				array(),
				'6.71',
				true
			);
