	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .oew-pricing-table .oew-pricing-table-list li svg' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .oew-pricing-table .oew-pricing-table-button i' => 'color: {{VALUE}}',
					'{{WRAPPER}} .oew-pricing-table .oew-pricing-table-button svg' => 'fill: {{VALUE}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .oew-pricing-table .oew-pricing-table-button i' => 'margin-right: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .oew-pricing-table .oew-pricing-table-button i' => 'font-size: {{SIZE}}{{UNIT}};line-height: 20px;',
					'{{WRAPPER}} .oew-pricing-table .oew-pricing-table-button svg' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};line-height: 20px;',
				),
			)
		);
