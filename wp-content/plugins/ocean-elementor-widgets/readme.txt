...
= 2.4.4 - MAY 22 2024 =
- Added: Support for Upgrade Swiper Library option.
- Added: Support for Inline Font Icons option.
- Added: Translations: Portuguese language.
- Updated: Compatibility: WordPress version number.
- Updated: Compatibility: Elementor version numbers.
- Fixed: Widgets: Member: SVG icon color not applied.

= 2.4.3 - APR 10 2024 =
- Fixed: Compatibility: WPML and Polylang: Warning: simplexml_load_file().

= 2.4.2 - APR 08 2024 =
- Updated: WPML translation file.
- Fixed: Woo Slider: Auto-play functionality issue.
